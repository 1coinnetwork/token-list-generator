    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.assets.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contract_address') ? 'is-invalid' : '' }}" type="text" name="contract_address" id="contract_address" value="{{ old('contract_address', '') }}" required>
