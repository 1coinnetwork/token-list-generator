    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.networks.update", [$network->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('chainid') ? 'is-invalid' : '' }}" type="number" name="chainid" id="chainid" value="{{ old('chainid', $network->chainid) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rpc_url') ? 'is-invalid' : '' }}" type="text" name="rpc_url" id="rpc_url" value="{{ old('rpc_url', $network->rpc_url) }}">
